...
## Set Vue app variables

  Set `auth0 domain`, `auth0 client ID` and the `GraphQL Engine URL` in `Vue-apollo-todo/src/constants.js`

## Run the Vue app

  Run `PORT=3000 npm run dev` from the `Vue-apollo-todo` directory to start the TODO app.
...
### Powered By:
  ...
  ![Hasura](static/hasura_mascot_logo_horizontal_200px.png)
